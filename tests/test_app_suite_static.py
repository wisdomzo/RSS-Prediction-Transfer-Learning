...
class AppSuiteStaticTests(unittest.TestCase):
    ...
    def test_system_data_analysis_view_supports_cdf_plot_and_downloads(self):
        ...
        self.assertNotIn('id="analysis-cdf-preview"', html)
        self.assertNotIn('id="analysis-csv-table"', html)
        self.assertNotIn('id="analysis-display-mode"', html)
        self.assertNotIn('id="analysis-empty-preview"', html)
        self.assertNotIn('data-analysis-tab="ensemble-cdf"', html)
        self.assertIn('data-analysis-tab="prediction-csv"', html)
        self.assertNotIn('id="analysis-panel-ensemble-cdf"', html)
        self.assertIn('id="analysis-panel-prediction-csv"', html)
        self.assertIn('class="analysis-stack"', html)
        self.assertNotIn('id="run-analysis-btn"', html)
        self.assertNotIn('onclick="selectAnalysisFolder()"', html)
        self.assertIn("resetDataAnalysis()", html)
        self.assertNotIn('id="download-analysis-svg-btn"', html)
        self.assertNotIn('id="download-analysis-png-btn"', html)
        self.assertIn('id="download-prediction-analysis-svg-btn"', html)
        self.assertIn('id="download-prediction-analysis-png-btn"', html)
        self.assertIn('id="prediction-analysis-type"', html)
        self.assertIn('value="rssi_cdf"', html)
        self.assertIn('value="predicted_value_cdf"', html)
        self.assertIn('value="uncertainty_cdf"', html)
        self.assertIn('value="absolute_error_cdf"', html)
        self.assertIn('value="model_error_boxplot"', html)
        self.assertIn('value="summary_statistics_table"', html)
        self.assertIn('value="predicted_vs_rssi_scatter"', html)
        self.assertIn('value="error_vs_distance"', html)
        self.assertIn('value="error_vs_altitude_fresnel"', html)
        self.assertIn('value="path_loss_baseline_cdf"', html)
        self.assertIn('value="uncertainty_calibration"', html)
        self.assertIn('value="model_error_violin"', html)
        self.assertIn('value="spatial_error_map"', html)
        self.assertIn('id="prediction-analysis-preview"', html)
        self.assertIn('id="prediction-analysis-csv-table"', html)
        self.assertNotIn("function selectAnalysisFolder", html)
        self.assertIn("function selectPredictionAnalysisFolder", html)
        self.assertNotIn("function renderAnalysisCsvFiles", html)
        self.assertIn("function renderPredictionAnalysisCsvFiles", html)
        self.assertIn("function resetDataAnalysis", html)
        self.assertIn("function showAnalysisPanel", html)
        self.assertNotIn("function runDataAnalysis", html)
        self.assertIn("function runPredictionCsvAnalysis", html)
        self.assertNotIn('class="analysis-csv-checkbox" data-index="${index}" />', html)
        self.assertIn('class="prediction-analysis-csv-checkbox" data-index="${index}" />', html)
        self.assertIn('class="prediction-analysis-color-input"', html)
        self.assertIn('class="prediction-analysis-color-text"', html)
        self.assertIn('analysisType: document.getElementById("prediction-analysis-type").value', html)
        self.assertNotIn("getSelectedAnalysisFileOptions", html)
        self.assertIn("getSelectedPredictionAnalysisFileOptions", html)
        self.assertIn("renderPredictionAnalysisSummary(result)", html)
        self.assertIn("const unitByType = {", html)
        self.assertIn("analysis-file-table", html)
        self.assertIn("analysis-summary analysis-output-width", html)
        ...
        self.assertIn("window.pywebview.api.executePredictionCsvAnalysis", html)
        self.assertIn("window.pywebview.api.reset_data_analysis_outputs()", html)
        self.assertIn("window.pywebview.api.download_data_analysis_svg(latestPredictionAnalysisOutputs.svg)", html)
        self.assertIn("window.pywebview.api.download_data_analysis_png(latestPredictionAnalysisOutputs.png)", html)
